...
{
    public class CANInventorySmelting : InventoryBase, ISlotProvider
    {
        public static HashSet<string> blockedCodes = new HashSet<string> { "nugget-magnetite", "nugget-hematite", "nugget-limonite" };
        ItemSlot[] slots;
        ...
        public CANInventorySmelting(string inventoryID, ICoreAPI api) : base(inventoryID, api)
        {
            // slot 0 = fuel
            // slot 1 = input
            // slot 2 = output
        ...
        public CANInventorySmelting(string className, string instanceID, ICoreAPI api) : base(className, instanceID, api)
        {
            slots = GenEmptySlots(7);
            cookingSlots = new ItemSlot[] { slots[3], slots[4], slots[5], slots[6] };
            baseWeight = 4f;
