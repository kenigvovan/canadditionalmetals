...
namespace canadditionalmetals.src.render
{
    public class CANBloomeryContentsRenderer : IRenderer, IDisposable
    {
        ...
        public IInBloomeryRenderer contentStackRenderer;
        ...
        public CANBloomeryContentsRenderer(ICoreClientAPI api, BlockPos pos)
        {
            this.api = api;
            this.pos = pos;
        ...
        internal void SetChildRenderer(ItemStack contentStack, IInBloomeryRenderer renderer)
        {
